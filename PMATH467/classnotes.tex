...
\begin{eg}\label{eg:2_sphere_as_a_manifold}
  ...
  \begin{figure}[ht]
    ...
    \begin{tikzpicture}
      ...
      \fill[color=be-red,opacity=0.3] (-2, 0, 0) arc (180:360:2) -- (2, 0, 0) arc (360:180:2 and 1);
      \fill[color=be-red,opacity=0.2] (-2, 0, 0) arc (180:0:2 and 1) -- (2, 0, 0) arc (360:180:2 and 1);

      % the axes
      \draw[dashed] (-3, 0, 0) -- (0, 0, 0);
      \draw[dashed] (0, -3, 0) -- (0, 0, 0);
      \draw[dashed] (0, 0, -3) -- (0, 0, 0);
      \draw[-latex'] (0, 0, 0) -- (3, 0, 0) node[right] {$y$};
