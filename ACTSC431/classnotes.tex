...
% subsection indiviual_risk_model
...
% subsection indiviual_risk_model (end)
...
\begin{solution}
  Let $X_i \sim X$, for $i = 1, 2, \ldots, N$. Then
  \begin{equation*}
  ...
  \begin{equation*}
    P( S < \pi_{0.95} ) \leq 0.95 \leq P ( \leq \pi_{0.95} ).
  \end{equation*}
  Then
  \begin{align*}
...
\paragraph{Discretization Method} The normal approximation has limitations: e.g. how large is large for each of the required parameters.
