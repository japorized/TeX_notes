...
\begin{defn}[Groups\index{Groups}]\label{defn:groups}
...
\begin{defn}[Abelian Group\index{Abelian Group}]\label{defn:abelian_group}
...
\begin{propo}[Cancellation Laws]\label{propo:cancellation_laws}
  ...
  \begin{enumerate}
    \item (\hlnoteb{Left and Right Cancellation})
      \begin{enumerate}
