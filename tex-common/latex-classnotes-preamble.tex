...
\newtheorem{marginaxiom}[thm]{\faShield \enspace Axiom}
    ...
    % theorem envs for margins without counter
\theoremprework{\textcolor{base16-eighties-magenta}{\hrule height 2pt width \marginparwidth}}
\theoremheaderfont{\color{base16-eighties-magenta}\normalfont\bfseries}
\theorempostwork{\textcolor{base16-eighties-magenta}{\hrule height 2pt width \marginparwidth}}
\theoremindent10pt
...
\titleformat{\subsubsection}%
  ...
  {\llap{\colorbox{base16-eighties-yellow}{\parbox{1.5cm}{\hfill\textcolor{base16-eighties-dark}{\thesubsection}}}}}% label
  {1em}% horizontal separation between label and title body
  {}% before the title body
  []% after the title body
