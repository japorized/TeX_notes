...
\begin{eg}
  ...
  \begin{equation*}
    \int_{\mathbb{R}} f \dif{\mu} = n \cdot \frac{1}{n} = 1,
  \end{equation*}
  for each $n$.
  Thus
  \begin{equation*}
...
\begin{thm}[Monotone Convergence Theorem (MCT)]\index{Monotone Convergence Theorem}\index{MCT}\label{thm:monotone_convergence_theorem}
