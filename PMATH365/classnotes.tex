...
\tuftepart{Submanifolds of \texorpdfstring{$\mathbb{R}^n$}{Rn}}
...
Quite often, submanifolds of $\mathbb{R}^n$ appear in an \hlnotec{implicitly},
...
\begin{note}
  ...
  $(\dif{\phi})_u$ of a parametrization is \hlnotec{independent of any
