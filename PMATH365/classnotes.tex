...
covered by a single parametrization is always orientable, and the
...
\begin{eg}[Non-orientability of the M\"{o}bius strip]\label{eg:mobius_strip_is_non_orientable}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{mobius_angle1.png}
    % \begin{tikzpicture}
    % \begin{axis}[
    %     hide axis,
    %     view={0}{40}
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{mobius_angle2.png}
    % \begin{tikzpicture}
    % \begin{axis}[
    %     hide axis,
    %     view={90}{40}
