...
\begin{thm}[Submanifold as Defined by a Smooth Map of Maximal Rank]\label{thm:submanifold_as_defined_by_a_smooth_map_of_maximal_rank}
...
\begin{thm}[Implicit Submanifold Theorem]\index{Implicit Submanifold Theorem}\label{thm:implicit_submanifold_theorem}
