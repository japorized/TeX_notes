...
\begin{proof}
  ...
  \end{equation*}
  Therefore, $\forall z \in \gamma^*, \, F = \frac{g}{f} \in B(1, 1)$. Let $\gamma : [a, b] \to \mathbb{C}$ be a parameterization of $\gamma^*$. Consider the function $F \circ \gamma$, which is a closed path that is contained in $B(1, 1)$. $\because z = 0$ \hlwarn{lies outside}\footnote{Is $z = 0$ not on $\gamma^*$?}, we have $\ind{0}{F \circ \gamma} = 0$. Then
  \begin{align}
...
\begin{proof}
  ...
  (\hlwarn{there are some extra comments here which I shall include after confirming my notes, cause I am skeptical of what I've jotted down})
