...
\begin{note}
  ...
  i.e. in a simply connected domain, the \hlnoteb{integral does not depend on the chosen path}\footnote{This should remind you of \hyperref[thm:goursat_s_theorem]{Goursat's Theorem} and \hyperref[thm:cauchy_s_theorem_for_convex_set]{Cauchy's Theorem}}.
\end{note}
