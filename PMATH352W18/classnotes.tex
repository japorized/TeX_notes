...
% xcolor
\definecolor{base16-eighties-bg}{HTML}{2D2D2D}
\definecolor{base16-eighties-text}{HTML}{D3D0C8}
...
\pagecolor{base16-eighties-bg}
\color{base16-eighties-text}
\begin{document}
...
\begin{proof}
	...
	\begin{align*}
		...
		\leq &\abs{\frac{S_N(z_0 + h) - S_N(z_0)}{h} - S_N'(z_0)} + \abs{\frac{E_N(z_0 + h) - E_N(z_0)}{h}} + \abs{S_N'(z_0) - g(z_0)}.
	\end{align*}
	...
	\hlwarn{(Proof is incomplete, and will be continued in the following lecture)}
\end{proof}
