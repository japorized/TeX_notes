...
\begin{defn}[Closure]\index{Closure}\label{defn:closure}
  Let $A \susbeteq (X, d)$. We define the \hlnoteb{closure} $\bar{A}$ of $A$ to be
  \begin{equation*}
