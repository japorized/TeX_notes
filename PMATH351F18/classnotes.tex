...
\begin{eg}[Cantor Set]\label{eg:cantor_set}
  ...
  \begin{figure}[h]
    ...
    \begin{tikzpicture}
      ...
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (3,0) -- (6,0);
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (1,0) -- (2,0);
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (7,0) -- (8,0);

      \draw[{Bracket[length=5pt,width=15pt]}-{Bracket[length=5pt,width=15pt]},base16-eighties-red] (0, 0) -- (1, 0);
      \draw[{Bracket[length=5pt,width=15pt]}-{Bracket[length=5pt,width=15pt]},base16-eighties-red] (2, 0) -- (3, 0);
      \draw[{Bracket[length=5pt,width=15pt]}-{Bracket[length=5pt,width=15pt]},base16-eighties-red] (6, 0) -- (7, 0);
      \draw[{Bracket[length=5pt,width=15pt]}-{Bracket[length=5pt,width=15pt]},base16-eighties-red] (8, 0) -- (9, 0);
      
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (0.333333,0) -- (0.666667,0);
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (2.333333,0) -- (2.666667,0);
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (6.333333,0) -- (6.666667,0);
      \draw[{Arc Barb[length=5pt,width=15pt]}-{Arc Barb[length=5pt,width=15pt]},base16-eighties-blue] (8.333333,0) -- (8.666667,0);
    \end{tikzpicture}
    \end{center}
...
\begin{defn}[Dense]\index{Dense}\label{defn:dense}
  $A$ is \hlnoteb{dense} in $(X, d)$ if $\bar{A} = X$.
\end{defn}
...
\subsubsection{Completeness of $(C_b(X), \ell_\infty)$}%
\label{ssub:completeness_of_c_b_x_ell_infty_}
% subsubsection completeness_of_c_b_x_ell_infty_
...
% subsubsection completeness_of_c_b_x_ell_infty_ (end)
...
\subsubsection{Completeness of $(C_b(X), \ell_p)$ (Continued)}%
\label{ssub:completeness_of_c_b_x_ell_p_continued}
% subsubsection completeness_of_c_b_x_ell_p_continued

\begin{note}
  A normed linear space $V$ is called a \hldefn{Banach space}  if $(V, \norm\cdot)$ is complete with respect to $d_V$.
\end{note}

\begin{thm}[Completeness for $C_b(X)$]\label{thm:completeness_for_c_b_x_}
  The space $(C_b(X), \norm\cdot_\infty)$ is Banach (i.e. complete).
\end{thm}

% subsubsection completeness_of_c_b_x_ell_p_continued (end)
