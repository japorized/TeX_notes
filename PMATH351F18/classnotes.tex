...
\begin{defn}[Relatively Compact Sets]\index{Relatively Compact Sets}\label{defn:relatively_compact_sets}
  Let $A \subset (X, d)$. We say that $A$ is \hlnoteb{relatively compact} if $\bar{A}$ is compact.
\end{defn}
