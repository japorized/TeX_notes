...
\begin{eg}
  ...
  $\abs{f}$ is measurable, it is not necessary that $f$ is not measurable.
...
\begin{eg}
  \begin{enumerate}
    \item Let $\phi = 0 \chi_{[4, \infty)} + 17 \xi_{\mathbb{Q} \cap [0, 4)} +
...
\begin{lemma}[Linearity, Monotonicity of the Lebesgue Integral]\label{lemma:linearity_monotonicity_of_the_lebesgue_integral}
...
\begin{ex}
  Prove \cref{lemma:linearity_monotonicity_of_the_lebesgue_integral}.
\end{ex}
...
\begin{proof}
  \begin{enumerate}
    ...
    \item Let $B \coloneqq \{ x \in E : f(x) \neq g(x) \}$ so that $mB = 0$.
      Then by \cref{lemma:linearity_monotonicity_of_the_lebesgue_integral} and
      part (1), we have
      \begin{align*}
